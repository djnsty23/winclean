...
echo     $timeString = "$hour:00" >> "%tempPS%"
echo     if ($triggerType -eq 'DAILY') { >> "%tempPS%"
echo         $trigger = New-ScheduledTaskTrigger -Daily -At $timeString >> "%tempPS%"
echo     } elseif ($triggerType -eq 'WEEKLY') { >> "%tempPS%"
echo         $trigger = New-ScheduledTaskTrigger -Weekly -DaysOfWeek Sunday -At $timeString >> "%tempPS%"
echo     } else { >> "%tempPS%"
echo         $trigger = New-ScheduledTaskTrigger -Daily -At $timeString >> "%tempPS%"
echo     } >> "%tempPS%"
echo. >> "%tempPS%"
